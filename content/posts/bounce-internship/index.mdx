...
This was followed by an assignment where I was asked to design a self-pickup from restaurant model for Swiggy. I wrote a PRD for that, which you can check out [here](https://bit.ly/SwiggyPRD).
