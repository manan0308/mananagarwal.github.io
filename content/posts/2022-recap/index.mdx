...
#### 🚨 This list has a lot of survivorship bias.

**1. Graduated with a Mechatronics (robotics) engineering degree from Manipal.**

_Feels good to have an engineering degree in a field that is a bit niche. However, I practically don’t remember most of it, thanks to an online college experience._

**2. Started a full-time product management job at Razorpay as an APM.**

_I joined Razorpay full-time on 3rd Jan 2021(the first working day of 2021), and it has been an insanely fulfilling year at work.The amount of learning I have had on PMing and how scaled startups operate is insane, and I am so grateful I decided to go down this route. [Thread storm](https://twitter.com/manan_0308/status/1477276091932839936?s=20&t=FOfHk7oRVBq5zQwpsHVyBg) on what it took to get here._
...
_I made my share of splurges (a flight simulator setup is really needed) but did reasonably well overall._
...
_Go to Vietnam. In all seriousness, I need to go on at least one solo trip, either to the mountains or the beaches in India, this year. Want to watch the cricket world cup final live this year too. Since it is happening in India, hopefully, the Indian team makes it._
